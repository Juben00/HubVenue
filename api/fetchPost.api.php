...
if ($properties) {
    foreach ($properties as $property) {
        echo '
        <a href="./viewPropPost.php?id=' . $property['p_id'] . '" class="property-item shadow-sm hover:-translate-y-2 border-2 ease-out max-w-[500px] overflow-hidden rounded-lg relative shadow-neutral-50 duration-500">
                        ...
                        <div class="flex justify-between items-center w-full">
                            <div class="bg-neutral-200 rounded-full flex items-center p-1">
                                <div class="bg-red-500 rounded-full p-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="text-neutral-100" fill="currentColor" class="bi bi-tag-fill" viewBox="0 0 16 16">
