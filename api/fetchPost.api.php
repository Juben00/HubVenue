...
if ($properties) {
    foreach ($properties as $property) {
        echo '
        <a href="./property.php?id=' . $property['p_id'] . '" class="property-item shadow-sm hover:-translate-y-2 border-2 ease-out max-w-[500px] overflow-hidden rounded-lg relative shadow-neutral-50 duration-500">
