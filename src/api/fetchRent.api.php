...
if (!empty($rented)) {
  ...
  <div class="h-full flex-1">
      <div class="p-2 h-full w-full">
          ...
          <a href="https://www.google.com/maps/search/?api=1&query=' . htmlspecialchars($rent['location']) . '" class="text-neutral-200 text-xs underline underline-offset-1 truncate" target="_blank" >Location: ' . htmlspecialchars($rent['location']) . '</a>
