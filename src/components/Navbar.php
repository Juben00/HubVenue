            ...
            <div class="hidden flex-col w-48 gap-2 bg-neutral-800 absolute top-16 right-0 rounded-md border border-red-500 p-4"
                ...
                <div class="flex items-center ">
                    <div class="flex items-center gap-2 flex-1">
                        ...
                        <a href="./profile.php?userid=<?= $_SESSION['id'] ?>"
                            class="hover:underline hover:underline-offset-2">Profile</a>
                    </div>
                ...
                <div class="flex items-center ">
                    <div class="flex items-end gap-2 flex-1">
                        ...
                        <a href="#" class="hover:underline hover:underline-offset-2">Settings</a>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-chevron-right" viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
        ...
        <ul id="mobile-menu"
            ...
            <li>
                <div class="flex items-center w-fit gap-2">
                    ...
                    <a href="#" class="block py-2 hover:underline hover:underline-offset-2">Profile</a>
                </div>
            </li>
            <li>
                <div class="flex items-center w-fit gap-2">
            ...
            <li>
                <div class="flex items-center w-fit gap-2">
                    ...
                    <a href="#" class="block py-2 hover:underline hover:underline-offset-2">Settings</a>
                </div>
            </li>
            <li>
                <div class="flex items-center w-fit gap-2">
