...
//if the user is not logged in, set variable to true
$loggedOut = !isset($_SESSION['id']);
    ...
    <div class=" container mx-auto px-8 flex items-center justify-between ">
        ...
        <ul class="hidden lg:flex space-x-4 relative">
            ...
            <?php else: ?>
                ...
                <div class="hidden flex-col w-48 gap-2 border-red-500 bg-neutral-200 absolute top-16 right-0 rounded-md border p-4"
                    id="options">
                    <div class="flex items-center">
                        <div class="flex items-center gap-2 flex-1">
                            ...
                            <a href="./profile.php" class="hover:underline hover:underline-offset-2">Profile</a>
                        </div>
        ...
        <ul id="mobile-menu"
            class="hidden flex-col space-y-2 bg-neutral-200 p-4 z-50 absolute top-20 left-0 right-0 lg:hidden text-center">
            <li>
                <div class="flex items-center w-fit gap-2">
                    ...
                    <a href="./profile.php" class="block py-2 hover:underline hover:underline-offset-2">Profile</a>
                </div>
            </li>
            <li>
                <div class="flex items-center w-fit gap-2">
                    ...
                    <a href="#" class="block py-2 hover:underline hover:underline-offset-2">Services</a>
                </div>
            </li>
            <li>
                <div class="flex items-center w-fit gap-2">
                    ...
                    <a href="#" class="block py-2 hover:underline hover:underline-offset-2">About</a>
                </div>
            </li>
            <li>
                <div class="flex items-center w-fit gap-2">
                    ...
                    <a href="#" class="block py-2 hover:underline hover:underline-offset-2">Contact</a>
                </div>
            </li>
            <li>
                <div class="flex items-center w-fit gap-2">
                    ...
                    <a href="./settings.php" class="block py-2 hover:underline hover:underline-offset-2">Settings</a>
                </div>
            </li>
            <li>
                <div class="flex items-center w-fit gap-2">
                    ...
                    <a href="logout.php" class="block py-2 hover:underline hover:underline-offset-2">Logout</a>
                </div>
            </li>
        </ul>
    </div>
